...
*/
 void duckdb_scalar_function_set_init(duckdb_scalar_function scalar_function,
...
*/
 void duckdb_scalar_function_init_set_state(duckdb_init_info info, void *state,
                                                        duckdb_delete_callback_t destroy);
...
*/
 void duckdb_scalar_function_init_get_client_context(duckdb_init_info info,
                                                                 duckdb_client_context *out_context);
...
* @param error The error message
*/
 void duckdb_copy_function_global_init_set_error(duckdb_copy_function_global_init_info info,
                                                             const char *error);
...
*/
 duckdb_logical_type duckdb_table_function_bind_get_result_column_type(duckdb_bind_info info,
                                                                                   idx_t col_idx);
